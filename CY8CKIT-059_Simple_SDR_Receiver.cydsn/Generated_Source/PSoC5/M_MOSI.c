...
*
* \funcusage
*  \snippet M_MOSI_SUT.c usage_M_MOSI_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet M_MOSI_SUT.c usage_M_MOSI_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet M_MOSI_SUT.c usage_M_MOSI_Read  
*******************************************************************************/
...
* preferred M_MOSI_Read() API because the 
* M_MOSI_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet M_MOSI_SUT.c usage_M_MOSI_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: M_MOSI_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use M_MOSI_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - M_MOSI_0_INTR       (First pin in the list)
    *  - M_MOSI_1_INTR       (Second pin in the list)
    *  - ...
    *  - M_MOSI_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet M_MOSI_SUT.c usage_M_MOSI_SetInterruptMode
    *******************************************************************************/
    void M_MOSI_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & M_MOSI_0_INTR) != 0u) 
		{ 
			 M_MOSI_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet M_MOSI_SUT.c usage_M_MOSI_ClearInterrupt
    *******************************************************************************/
