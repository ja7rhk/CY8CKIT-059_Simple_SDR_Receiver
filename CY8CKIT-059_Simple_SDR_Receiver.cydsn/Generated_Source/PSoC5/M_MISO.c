...
*
* \funcusage
*  \snippet M_MISO_SUT.c usage_M_MISO_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet M_MISO_SUT.c usage_M_MISO_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet M_MISO_SUT.c usage_M_MISO_Read  
*******************************************************************************/
...
* preferred M_MISO_Read() API because the 
* M_MISO_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet M_MISO_SUT.c usage_M_MISO_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: M_MISO_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use M_MISO_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - M_MISO_0_INTR       (First pin in the list)
    *  - M_MISO_1_INTR       (Second pin in the list)
    *  - ...
    *  - M_MISO_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet M_MISO_SUT.c usage_M_MISO_SetInterruptMode
    *******************************************************************************/
    void M_MISO_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & M_MISO_0_INTR) != 0u) 
		{ 
			 M_MISO_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet M_MISO_SUT.c usage_M_MISO_ClearInterrupt
    *******************************************************************************/
