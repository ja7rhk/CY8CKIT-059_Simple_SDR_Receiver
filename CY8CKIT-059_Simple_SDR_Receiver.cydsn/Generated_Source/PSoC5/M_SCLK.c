...
*
* \funcusage
*  \snippet M_SCLK_SUT.c usage_M_SCLK_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet M_SCLK_SUT.c usage_M_SCLK_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet M_SCLK_SUT.c usage_M_SCLK_Read  
*******************************************************************************/
...
* preferred M_SCLK_Read() API because the 
* M_SCLK_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet M_SCLK_SUT.c usage_M_SCLK_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: M_SCLK_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use M_SCLK_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - M_SCLK_0_INTR       (First pin in the list)
    *  - M_SCLK_1_INTR       (Second pin in the list)
    *  - ...
    *  - M_SCLK_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet M_SCLK_SUT.c usage_M_SCLK_SetInterruptMode
    *******************************************************************************/
    void M_SCLK_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & M_SCLK_0_INTR) != 0u) 
		{ 
			 M_SCLK_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet M_SCLK_SUT.c usage_M_SCLK_ClearInterrupt
    *******************************************************************************/
