...
*
* \funcusage
*  \snippet M_SS_SUT.c usage_M_SS_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet M_SS_SUT.c usage_M_SS_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet M_SS_SUT.c usage_M_SS_Read  
*******************************************************************************/
...
* preferred M_SS_Read() API because the 
* M_SS_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet M_SS_SUT.c usage_M_SS_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: M_SS_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use M_SS_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - M_SS_0_INTR       (First pin in the list)
    *  - M_SS_1_INTR       (Second pin in the list)
    *  - ...
    *  - M_SS_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet M_SS_SUT.c usage_M_SS_SetInterruptMode
    *******************************************************************************/
    void M_SS_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & M_SS_0_INTR) != 0u) 
		{ 
			 M_SS_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet M_SS_SUT.c usage_M_SS_ClearInterrupt
    *******************************************************************************/
