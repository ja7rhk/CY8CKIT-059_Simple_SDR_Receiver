 ...
 * n_si5351_init
 */
void si5351_init(int32_t freq_xtal, int32_t xtal_correction, int load_cap)
{
    int clock;
 ...
 */
void si5351_calibration_mode(int enable)
{
 ...
 */
void si5351_clock_enable(enum si5351_clock clk, int enable)
{
    uint8_t reg_val;
 ...
 * 
 */
int32_t si5351_set_frequency(int32_t freq, int32_t pll_freq,
  enum si5351_clock clock, int reset)
{
    uint8_t clk_ctrl, pllregs[8], msregs[8];
    int addr = SI5351_PLLA_PARAMETERS;
    int pll_prog = SI5351_PLLA;
    int program_pll = 0;
...
static int32_t pll_calc(int32_t freq, uint8_t *regs)
{
    uint32_t a, b, c;
    uint32_t p1, p2, p3;
...
static int32_t multisynth_calc(int32_t freq, int32_t pll_freq, uint8_t *clk_ctrl, uint8_t *regs)
{
    int32_t a, b, c;
    uint32_t p1, p2, p3;
