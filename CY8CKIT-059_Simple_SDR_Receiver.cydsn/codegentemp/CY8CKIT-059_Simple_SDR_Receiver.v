// ======================================================================
// CY8CKIT-059_Simple_SDR_Receiver.v generated from TopDesign.cysch
// 06/22/2019 at 20:46
...
module ADC_DelSig_v3_20_1 (
	...
	cy_clock_v1_0
		#(.id("a93a6fa0-bc43-448c-8f1c-0f86aff37d8d/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("a93a6fa0-bc43-448c-8f1c-0f86aff37d8d/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module I2C_v3_50_2 (
	...
	cy_clock_v1_0
		#(.id("952de639-dc03-4c0a-9f65-d607c44ce454/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f2118c7e-8833-484e-853f-9fcd2c54d7c5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8f8d846a-c6c0-4d98-9fbb-9ed598c6e572"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PLL_CLK_IN_net;
	wire [0:0] tmpIO_0__PLL_CLK_IN_net;
	wire [0:0] tmpINTERRUPT_0__PLL_CLK_IN_net;
	electrical [0:0] tmpSIOVREF__PLL_CLK_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("24fd8a52-689d-4ad0-a61b-70d3b7b1c603"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PLL_CLK_IN
		 (.oe(tmpOE__PLL_CLK_IN_net),
		  .y({1'b0}),
		  .fb({EXT_CLK}),
		  .io({tmpIO_0__PLL_CLK_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__PLL_CLK_IN_net),
		  .interrupt({tmpINTERRUPT_0__PLL_CLK_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PLL_CLK_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_407 = ~Net_1044;

    CyControlReg_v1_80 IQMUX (
        .control_1(IQ_select[1]),
        .control_2(Net_790),
        .control_3(Net_791),
        .control_0(IQ_select[0]),
        .control_4(Net_792),
        .control_5(Net_793),
        .control_6(Net_794),
        .control_7(Net_795),
        .clock(1'b0),
        .reset(1'b0));
    defparam IQMUX.Bit0Mode = 0;
    defparam IQMUX.Bit1Mode = 0;
    defparam IQMUX.Bit2Mode = 0;
    defparam IQMUX.Bit3Mode = 0;
    defparam IQMUX.Bit4Mode = 0;
    defparam IQMUX.Bit5Mode = 0;
    defparam IQMUX.Bit6Mode = 0;
    defparam IQMUX.Bit7Mode = 0;
    defparam IQMUX.BitValue = 0;
    defparam IQMUX.BusDisplay = 0;
    defparam IQMUX.ExtrReset = 0;
    defparam IQMUX.NumOutputs = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("87aa88e0-3c0d-4093-a998-dd8eec3be527"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("917aa147-f330-4a87-a278-c9a0ea8a39bc"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ICLK_net;
	wire [0:0] tmpFB_0__ICLK_net;
	wire [0:0] tmpIO_0__ICLK_net;
	wire [0:0] tmpINTERRUPT_0__ICLK_net;
	electrical [0:0] tmpSIOVREF__ICLK_net;

	cy_psoc3_pins_v1_10
		#(.id("3c71b1d7-019c-4988-9f82-d4e22ee420aa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ICLK
		 (.oe(tmpOE__ICLK_net),
		  .y({Net_1043}),
		  .fb({tmpFB_0__ICLK_net[0:0]}),
		  .io({tmpIO_0__ICLK_net[0:0]}),
		  .siovref(tmpSIOVREF__ICLK_net),
		  .interrupt({tmpINTERRUPT_0__ICLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ICLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__QCLK_net;
	wire [0:0] tmpFB_0__QCLK_net;
	wire [0:0] tmpIO_0__QCLK_net;
	wire [0:0] tmpINTERRUPT_0__QCLK_net;
	electrical [0:0] tmpSIOVREF__QCLK_net;

	cy_psoc3_pins_v1_10
		#(.id("9ab95290-6996-4ccd-bfbb-ec639642e7bb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		QCLK
		 (.oe(tmpOE__QCLK_net),
		  .y({Net_1044}),
		  .fb({tmpFB_0__QCLK_net[0:0]}),
		  .io({tmpIO_0__QCLK_net[0:0]}),
		  .siovref(tmpSIOVREF__QCLK_net),
		  .interrupt({tmpINTERRUPT_0__QCLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__QCLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ICHAN_net;
	wire [0:0] tmpFB_0__ICHAN_net;
	wire [0:0] tmpIO_0__ICHAN_net;
	wire [0:0] tmpINTERRUPT_0__ICHAN_net;
	electrical [0:0] tmpSIOVREF__ICHAN_net;

	cy_psoc3_pins_v1_10
		#(.id("e6b43955-de84-4232-b2b4-076dedb735a4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ICHAN
		 (.oe(tmpOE__ICHAN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ICHAN_net[0:0]}),
		  .analog({Net_788}),
		  .io({tmpIO_0__ICHAN_net[0:0]}),
		  .siovref(tmpSIOVREF__ICHAN_net),
		  .interrupt({tmpINTERRUPT_0__ICHAN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ICHAN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__QCHAN_net;
	wire [0:0] tmpFB_0__QCHAN_net;
	wire [0:0] tmpIO_0__QCHAN_net;
	wire [0:0] tmpINTERRUPT_0__QCHAN_net;
	electrical [0:0] tmpSIOVREF__QCHAN_net;

	cy_psoc3_pins_v1_10
		#(.id("5c213382-34ec-4ba2-9f66-4d8102c45318"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		QCHAN
		 (.oe(tmpOE__QCHAN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__QCHAN_net[0:0]}),
		  .analog({Net_789}),
		  .io({tmpIO_0__QCHAN_net[0:0]}),
		  .siovref(tmpSIOVREF__QCHAN_net),
		  .interrupt({tmpINTERRUPT_0__QCHAN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__QCHAN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("d869a64b-8051-4485-81d4-e78aed5d623f"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ADCREF_net;
	wire [0:0] tmpFB_0__ADCREF_net;
	wire [0:0] tmpIO_0__ADCREF_net;
	wire [0:0] tmpINTERRUPT_0__ADCREF_net;
	electrical [0:0] tmpSIOVREF__ADCREF_net;

	cy_psoc3_pins_v1_10
		#(.id("a6a7646d-73fb-41d2-8c2f-cb02e4061138"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ADCREF
		 (.oe(tmpOE__ADCREF_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADCREF_net[0:0]}),
		  .analog({Net_309}),
		  .io({tmpIO_0__ADCREF_net[0:0]}),
		  .siovref(tmpSIOVREF__ADCREF_net),
		  .interrupt({tmpINTERRUPT_0__ADCREF_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADCREF_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("9a105b33-e493-4400-87c6-ddf372bc61cb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__TP2_OUT_net;
	wire [0:0] tmpFB_0__TP2_OUT_net;
	wire [0:0] tmpIO_0__TP2_OUT_net;
	wire [0:0] tmpINTERRUPT_0__TP2_OUT_net;
	electrical [0:0] tmpSIOVREF__TP2_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("79be07c7-3043-4671-b430-b790142c4f01"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TP2_OUT
		 (.oe(tmpOE__TP2_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TP2_OUT_net[0:0]}),
		  .io({tmpIO_0__TP2_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__TP2_OUT_net),
		  .interrupt({tmpINTERRUPT_0__TP2_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TP2_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_psoc3_digital_sentinel_v1_0 EXT_CLK__sentinel (.watch(EXT_CLK));
