...
*
*******************************************************************************/
void Clock_2kHz_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = Clock_2kHz_GetSourceRegister();
    uint16 oldDivider = Clock_2kHz_GetDividerRegister();
...
*
*******************************************************************************/
uint16 Clock_2kHz_GetDividerRegister(void) 
{
...
{
    uint16 currDiv = Clock_2kHz_GetDividerRegister();
